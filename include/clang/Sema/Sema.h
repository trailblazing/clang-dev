...
public:
  ...
  bool IsCprofProcedure; // cleni, for pragma
  ...
  struct ExpressionEvaluationContextRecord {
    ...
    ExpressionEvaluationContextRecord(ExpressionEvaluationContext Context,
        ...
        : Context(Context), ParentCleanup(ParentCleanup),
          ...
          NumTypos(0), ManglingContextDecl(ManglingContextDecl),
          MangleNumbering() {}
  ...
  public:
    ...
    ~FPContractStateRAII() { S.FPFeatures.fp_contract = OldFPContractState; }
...
public:
  ...
  TypeSourceInfo *
  GetTypeSourceInfoForDeclarator(Declarator &D, QualType T,
...
public:
  ...
  Decl *ActOnEmptyDeclaration(Scope *S, AttributeList *AttrList,
  ...
  AvailabilityAttr *mergeAvailabilityAttr(
      ...
      StringRef Replacement, AvailabilityMergeKind AMK,
  ...
  void AddConversionCandidate(CXXConversionDecl *Conversion,
                              ...
                              CXXRecordDecl *ActingContext, Expr *From,
                              QualType ToType,
                              OverloadCandidateSet &CandidateSet,
...
public:
  ...
  TypoCorrection CorrectTypo(
      const DeclarationNameInfo &Typo, Sema::LookupNameKind LookupKind,
      Scope *S, CXXScopeSpec *SS,
      std::unique_ptr<CorrectionCandidateCallback> CCC, CorrectTypoKind Mode,
      DeclContext *MemberContext = nullptr, bool EnteringContext = false,
      const ObjCObjectPointerType *OPT = nullptr, bool RecordFailure = true);
  ...
  bool checkNullabilityTypeSpecifier(QualType &type,
  ...
  ObjCPropertyDecl *HandlePropertyInClassExtension(
      ...
      FieldDeclarator &FD, Selector GetterSel, Selector SetterSel,
      const bool isReadWrite, unsigned &Attributes,
      const unsigned AttributesAsWritten, QualType T, TypeSourceInfo *TSI,
      tok::ObjCKeywordKind MethodImplKind);

  /// Called by ActOnProperty and HandlePropertyInClassExtension to
  /// handle creating the ObjcPropertyDecl for a category or \@interface.
  ObjCPropertyDecl *CreatePropertyDecl(
      Scope *S, ObjCContainerDecl *CDecl, SourceLocation AtLoc,
      SourceLocation LParenLoc, FieldDeclarator &FD, Selector GetterSel,
      Selector SetterSel, const bool isReadWrite, const unsigned Attributes,
      const unsigned AttributesAsWritten, QualType T, TypeSourceInfo *TSI,
      tok::ObjCKeywordKind MethodImplKind, DeclContext *lexicalDC = nullptr);
...
public:
  ...
  public:
    CompoundScopeRAII(Sema &S) : S(S) { S.ActOnStartOfCompoundStmt(); }
  ...
  StmtResult ActOnCXXForRangeStmt(Scope *S, SourceLocation ForLoc,
                                  SourceLocation CoawaitLoc, Stmt *LoopVar,
  ...
  ExprResult ActOnDesignatedInitializer(Designation &Desig, SourceLocation Loc,
...
public:
  ...
  Decl *ActOnStartNamespaceDef(Scope *S, SourceLocation InlineLoc,
                               ...
                               SourceLocation LBrace, AttributeList *AttrList,
  ...
  bool CheckUsingDeclQualifier(SourceLocation UsingLoc, const CXXScopeSpec &SS,
                               const DeclarationNameInfo &NameInfo,
                               SourceLocation NameLoc);

  NamedDecl *
  BuildUsingDeclaration(Scope *S, AccessSpecifier AS, SourceLocation UsingLoc,
                        CXXScopeSpec &SS, DeclarationNameInfo NameInfo,
                        AttributeList *AttrList, bool IsInstantiation,
  ...
  Decl *ActOnUsingDeclaration(Scope *CurScope, AccessSpecifier AS,
                              bool HasUsingKeyword, SourceLocation UsingLoc,
                              CXXScopeSpec &SS, UnqualifiedId &Name,
                              AttributeList *AttrList, bool HasTypenameKeyword,
                              SourceLocation TypenameLoc);
  Decl *ActOnAliasDeclaration(Scope *CurScope, AccessSpecifier AS,
                              MultiTemplateParamsArg TemplateParams,
                              SourceLocation UsingLoc, UnqualifiedId &Name,
                              AttributeList *AttrList, TypeResult Type,
  ...
  ExprResult BuildCXXNew(SourceRange Range, bool UseGlobal,
                         ...
                         TypeSourceInfo *AllocTypeInfo, Expr *ArraySize,
  ...
  ExprResult ActOnFinishFullExpr(Expr *Expr) {
    return ActOnFinishFullExpr(Expr,
                               Expr ? Expr->getExprLoc() : SourceLocation());
  }
  ...
  TemplateNameKind isTemplateName(Scope *S, CXXScopeSpec &SS,
                                  bool hasTemplateKeyword, UnqualifiedId &Name,
  ...
  Decl *ActOnTypeParameter(Scope *S, bool Typename, SourceLocation EllipsisLoc,
  ...
  Decl *ActOnNonTypeTemplateParameter(Scope *S, Declarator &D, unsigned Depth,
                                      unsigned Position,
                                      SourceLocation EqualLoc,
                                      Expr *DefaultArg);
  Decl *ActOnTemplateTemplateParameter(
  ...
  ActOnTemplateParameterList(unsigned Depth, SourceLocation ExportLoc,
                             SourceLocation TemplateLoc,
                             SourceLocation LAngleLoc, ArrayRef<Decl *> Params,
  ...
  ActOnTemplateIdType(CXXScopeSpec &SS, SourceLocation TemplateKWLoc,
                      ...
                      SourceLocation LAngleLoc, ASTTemplateArgsPtr TemplateArgs,
                      SourceLocation RAngleLoc, bool IsCtorOrDtorName = false);
  ...
  TemplateNameKind ActOnDependentTemplateName(Scope *S, CXXScopeSpec &SS,
                                              SourceLocation TemplateKWLoc,
                                              UnqualifiedId &Name,
                                              ParsedType ObjectType,
                                              bool EnteringContext,
  ...
  DeclResult ActOnExplicitInstantiation(
      ...
      SourceLocation LAngleLoc, ASTTemplateArgsPtr TemplateArgs,
      SourceLocation RAngleLoc, AttributeList *Attr);
  ...
  /// unexpanded parameter packs.
  void collectUnexpandedParameterPacks(
      CXXScopeSpec &SS, SmallVectorImpl<UnexpandedParameterPack> &Unexpanded);
  ...
  struct OriginalCallArg {
    OriginalCallArg(QualType OriginalParamType, unsigned ArgIdx,
  ...
  DeduceTemplateArguments(FunctionTemplateDecl *FunctionTemplate,
                          TemplateArgumentListInfo *ExplicitTemplateArgs,
                          ArrayRef<Expr *> Args, FunctionDecl *&Specialization,
                          sema::TemplateDeductionInfo &Info,
                          bool PartialOverloading = false);
  ...
  SubstFunctionDeclType(TypeSourceInfo *T,
                        const MultiLevelTemplateArgumentList &TemplateArgs,
                        SourceLocation Loc, DeclarationName Entity,
                        CXXRecordDecl *ThisContext, unsigned ThisTypeQuals);
  ...
  void InstantiateVariableDefinition(SourceLocation PointOfInstantiation,
                                     ...
                                     bool AtEndOfTU = false);
  void
  InstantiateStaticDataMemberDefinition(SourceLocation PointOfInstantiation,
                                        VarDecl *Var, bool Recursive = false,
                                        bool DefinitionRequired = false);
  ...
  void ActOnPendingCprofPragma(FunctionDecl *FD);     // cleni, for pragma
  void ActOnPragmaCprofProcedure(StringRef funcName); // cleni, for pragma
  ...
  void AddParameterABIAttr(SourceRange AttrRange, Decl *D, ParameterABI ABI,
                           unsigned SpellingListIndex);
...
public:
  ...
  // omph extension
  OMPClause *ActOnOpenMPDeviceExprClause(Expr *NumForLoops,
                                         SourceLocation StartLoc,
                                         SourceLocation LParenLoc,
                                         SourceLocation EndLoc);
  ...
  ARCConversionResult
  CheckObjCARCConversion(SourceRange castRange, QualType castType, Expr *&op,
                         CheckedConversionKind CCK, bool Diagnose = true,
  ...
  bool CheckMessageArgumentTypes(QualType ReceiverType, MultiExprArg Args,
                                 Selector Sel,
                                 ArrayRef<SourceLocation> SelectorLocs,
...
public:
  ...
  void CodeCompleteObjCPropertySynthesizeIvar(Scope *S,
                                              IdentifierInfo *PropertyName);
  void CodeCompleteObjCMethodDecl(Scope *S, bool IsInstanceMethod,
...
public:
  ...
  EnterExpressionEvaluationContext(Sema &Actions,
    ...
    Actions.PushExpressionEvaluationContext(
        NewContext, Sema::ReuseLambdaContextDecl, IsDecltype);
  }
