...
void OMPClauseEnqueue::VisitOMPDeviceClause(const OMPDeviceClause *C) {
  ...
  printf("!!! >>>>>void OMPClauseEnqueue::VisitOMPDeviceClause(const "
	 "OMPDeviceClause *C)");
  //        printf("%d", C);
  printf("<<<<< !!!\n");
  //	char str[2048];
...
enum CXErrorCode clang_createTranslationUnit2(CXIndex CIdx,
  ...
  std::unique_ptr<ASTUnit> AU = ASTUnit::LoadFromASTFile(
      ...
      FileSystemOpts, /*UseDebugInfo=*/false, CXXIdx->getOnlyLocalDecls(), None,
...
int clang_getCursorPlatformAvailability(CXCursor cursor, int *always_deprecated,
  ...
  return getCursorPlatformAvailabilityForDecl(
      D, always_deprecated, deprecated_message, always_unavailable,
