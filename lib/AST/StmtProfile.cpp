...
//#define OPENMP_CLAUSE_EXT(Name, Class, NAMESPACE)                              \
//  void Visit##Class(const NAMESPACE::Class *C);
#define OPENMP_CLAUSE(Name, Class) void Visit##Class(const Class *C);
//  OPENMP_CLAUSE_EXT(device, OMPDeviceClause, omph)
#include "clang/Basic/OpenMPKinds.def"
  //  void VisitOMPDeviceClause(const omph::OMPDeviceClause *C);
...
void OMPClauseProfiler::VisitOMPDeviceClause(const omph::OMPDeviceClause *C) {

  printf("!!! >>>>>void OMPClauseProfiler::VisitOMPDeviceClause(const "
	 "OMPDeviceClause *C)");
  //  printf("%d", C);
  printf("<<<<< !!!\n");
  //	char str[2048];
...
void StmtProfiler::VisitOMPTargetDirective(const OMPTargetDirective *S) {
  printf("!!! >>>>>void StmtProfiler::VisitOMPTargetDirective(const "
